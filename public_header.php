...
<a href="station_registration.php">station registration</a> -->
                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="user_registration.php" class="nav-item nav-link">user_registration</a>
                            <a href="station_registration.php" class="nav-item nav-link">station registration</a>
